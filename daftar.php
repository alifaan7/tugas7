...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    elseif (!ctype_digit((string)$umur_raw)) {
        ...
        if ($umur < 10) {
            ...
            echo '</tbody></table>';
            echo '<div class="back"><a href="index.html">Silahkan kembali ke Form Registrasi</a></div>';
        }
    }

} else {
    echo '<div class="err">Error: 909 Not Found. Silahkan isi form registrasi terlebih dahulu.</div>';
    echo '<div class="back"><a href="index.html">Kembali ke Form Registrasi</a></div>';
}
?>
</div>
